...
export const HAZARD_LAYERS = [
  ...
  },
  {
    ...
    rrStep: HAZARD_STEP,
    sources: [
      { id: "MX-J3YTW-RUQN3-40P87", label: "250 yr", desc: "Peak Ground Acceleration from the GEM Global Seismic Hazard Map." },
      { id: "MX-4XSGY-9URYF-WMICZ", label: "475 yr", desc: "Peak Ground Acceleration from the GEM Global Seismic Hazard Map." },
      { id: "MX-KE2UX-GL8CM-IZSIA", label: "975 yr", desc: "Peak Ground Acceleration from the GEM Global Seismic Hazard Map." },
      { id: "MX-SFF5U-3O2XL-SAIL9", label: "1500 yr", desc: "Peak Ground Acceleration from the GEM Global Seismic Hazard Map." },
      { id: "MX-MWJ8Z-JYVYX-N9T0T", label: "2475 yr", desc: "Peak Ground Acceleration from the GEM Global Seismic Hazard Map." },
    ],
