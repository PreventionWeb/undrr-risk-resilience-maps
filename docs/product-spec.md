...
- UNDRR Mangrove design system v2.0.0-rc.1
...
| Layer toggle, opacity, legend   | Structured legends for supported vector/discrete raster contracts; MapX image fallback otherwise |
