...
- Updated to stable `2.0.0` (following release candidates `2.0.0-rc.1` through `2.0.0-rc.3`).
  Continue to monitor breaking changes listed in Mangrove's `llms.txt` (notably the
